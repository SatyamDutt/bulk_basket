...
class CartOrderAddressScreen extends StatefulWidget {
  final String userId;
  ...
  @override
  State<CartOrderAddressScreen> createState() => _CartOrderAddressScreenState();
}

class _CartOrderAddressScreenState extends State<CartOrderAddressScreen> {
    ...
    if (villageName.isEmpty ||
      ...
      try {
        ...
        await FirebaseFirestore.instance
          ...
          'Delivery Address': '${villageName}, ${landmark}, ${cityName}, ${postalCode}, ${stateName} ',
